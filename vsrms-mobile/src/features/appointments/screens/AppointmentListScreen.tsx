...
type TabKey = "bookings" | "repairs" | "history";
    ...
    <ScreenWrapper bg="#1A1A2E">
      ...
      <View style={styles.topSection}>
        ...
        <View style={styles.tabContainer}>
          {(["bookings", "repairs", "history"] as const).map((t) => (
            <TouchableOpacity
              key={t}
              onPress={() => setTab(t)}
      ...
      <View style={[styles.mainCard, { overflow: "hidden" }]}>
        {isLoading && !data ? (
          ...
          <FlashList
            ...
            keyExtractor={(a: Appointment) =>
              a._id || a.id || Math.random().toString()
            }
...
const styles = StyleSheet.create((theme) => ({
  ...
  decCircle1: {
    ...
    height: 140,
    borderRadius: 70,
    backgroundColor: "rgba(245,110,15,0.12)",
    top: -30,
    right: -20,
  },
  decCircle2: {
    ...
    height: 80,
    borderRadius: 40,
    backgroundColor: "rgba(245,110,15,0.06)",
    bottom: 10,
    right: 90,
  },
